# Emetric 0.42.0-beta.1 — Manual Test Checklist
...
| Emetric version | 0.42.0-beta.1 |
| Script file tested | `dist/beta/Emetric-0.42.0-beta.1.jsx` |
...
- [ ] Copy or run `Emetric-0.42.0-beta.1.jsx` in Adobe InDesign.
- [ ] The Emetric dialog opens without an ExtendScript error.
- [ ] The window title shows `Emetric 0.42.0-beta.1` and beta status.
...
## 14. Known backlog / not required for beta.1 pass

These items are noted for a future version and should not fail beta.1 unless they break existing behavior.

- [ ] Additional units such as Japanese Q are not expected in beta.1.
- [ ] Portrait/Landscape orientation switching is not expected in beta.1.
- [ ] Wider localization or translated UI is not expected in beta.1.
