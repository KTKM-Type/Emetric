...
(function () {
    ...
    var oVerticalLine = addRow(pVertical, "Grid Interval", "", false, "mm");
    ...
    var oHorizontalLine = addRow(pHorizontal, "Grid Interval", "", false, "mm");
    ...
    function refreshColorHexFieldsAfterLayout() {
        ...
        // the Custom Metric controls expand/collapse. Rewriting the current
        // values keeps Baseline Grid and Document Grid HEX fields visible.
        var selectors = [
            guideColorSelector,
            marginColorSelector,
            columnColorSelector,
