...
(function () {
    ...
    var oGridWidth = addRow(pVertical, "Grid Width", "", false, "mm");
    ...
    oVerticalGridline.helpTip =
        "Gridline Every multiplied by Steps; the height of one vertical grid module.";
    try { oVerticalGridline.label.helpTip = oVerticalGridline.helpTip; } catch (_) {}
    oHorizontalGridline.helpTip =
        "Gridline Every multiplied by Steps; the width of one horizontal grid module.";
    ...
    var oFormatRatio =
        addRatioRow(pPage, "Page Ratio", "", "", false);
