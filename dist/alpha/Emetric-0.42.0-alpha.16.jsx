...
(function () {
    ...
    function addColorSelector(parent, label, defaultHex, labelWidth) {
        ...
        hexField.onChanging = function () {
            ...
            if (/^#[0-9A-F]{6}$/.test(raw)) {
                ...
                // Do not mark the value as committed while the user is still
                // typing. Preview is updated from onChange, i.e. after Enter
                // or focus-out, matching the rest of the numeric fields.
            }
        };
    ...
    function beginEmetricInputEditing(
        ...
        // While an edit field is active, keep Preview from rebuilding on
        // pending idle tasks. The committed onChange handler will schedule
        // the next Preview update after Enter or focus-out.
        cancelPreviewUpdate();
