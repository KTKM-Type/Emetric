...
(function () {
    ...
    function applyLatestTooltipCopy() {
        ...
        setRatioTooltip(
            fMetricsLine,
            "Set the Metrics to Leading ratio.",
            "First value in the Metrics to Leading ratio.",
            "Second value in the Metrics to Leading ratio."
        );
